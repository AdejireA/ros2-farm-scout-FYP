...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('use_slam', default_value='false',
                              description='true=SLAM Toolbox, false=static map->odom transform + saved map'),
        DeclareLaunchArgument('map_file',
                              default_value='/home/ssrlserg1/ros2_ws/src/nav2_config/maps/farm_map.yaml',
                              description='Absolute path to map YAML for the static-transform localisation mode'),
